    ...
    >
      ...
      <div className="w-full max-w-xs sm:max-w-md md:max-w-2xl flex flex-col items-center text-center px-2 sm:px-4">
        ...
        <p className="text-base sm:text-lg md:text-xl text-neutral-900 dark:text-white max-w-full sm:max-w-2xl mx-auto mb-4 sm:mb-5 leading-relaxed">
          <span className="font-bold text-neutral-900 dark:text-white">Fullstack</span> dev fluent in <span className="font-bold text-neutral-900 dark:text-white">React</span>, dreaming in <span className="font-bold text-neutral-900 dark:text-white">Next.js</span>, and wrangling <span className="font-bold text-neutral-900 dark:text-white">MongoDB/PostgreSQL</span> with minimal chaos. Currently working as a <span className="font-bold text-neutral-900 dark:text-white">Fullstack Developer Intern</span> at <span className="font-bold text-neutral-900 dark:text-white">Legal Care</span>. Into <span className="font-bold text-neutral-900 dark:text-white">AI</span>, <span className="font-bold text-neutral-900 dark:text-white">Web3</span>, and <span className="font-bold text-neutral-900 dark:text-white">DevOps</span> (yes, I rant about Docker). Clean code, good vibes, and better memes — let&apos;s build something wild.
        </p>
      </div>
      ...
      <div className="w-full flex flex-col gap-2 sm:flex-row sm:justify-center sm:items-center sm:gap-4 mt-0 mb-0 px-2">
        <a href="/Soumaditya_Resume.pdf" download className="w-full sm:w-auto bg-white dark:bg-neutral-900 border border-neutral-300 dark:border-neutral-700 text-neutral-900 dark:text-white px-4 py-3 rounded-xl font-medium flex items-center justify-center gap-2 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition text-base sm:text-lg">
