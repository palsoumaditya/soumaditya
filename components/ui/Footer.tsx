    ...
    <footer id="contact" className="bg-gradient-to-b from-background to-neutral-50 dark:to-neutral-900 py-8 mt-12">
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8 justify-items-center md:justify-items-start text-center md:text-left">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-center md:justify-start space-x-2">
                ...
                <div>
                  ...
                  <a 
                    ...
                    className="text-sm text-neutral-900 dark:text-white font-medium hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                  >
              ...
              <div className="flex items-center justify-center md:justify-start space-x-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-900 dark:text-white font-medium">Kolkata, India</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Quick Links */}
          <div className="space-y-3">
            <h3 className="text-base font-semibold text-neutral-900 dark:text-white mb-3">Quick Links</h3>
            <div className="space-y-1">
              <a href="#about" className="block text-sm text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white transition-colors">
                About
              </a>
              <a href="#experience" className="block text-sm text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white transition-colors">
                Experience
              </a>
              <a href="#projects" className="block text-sm text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white transition-colors">
                Projects
              </a>
              <a href="#tech-stack" className="block text-sm text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white transition-colors">
                Tech Stack
              </a>
            </div>
          </div>
