  ...
  return (
    <section className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl md:text-3xl font-bold text-white">About Edu-Empower</h2>
      </div>
      {/* Action Buttons */}
      <div className="flex gap-4 mb-8">
        <a href="#" className="flex items-center gap-2 bg-neutral-800 hover:bg-neutral-700 text-white px-4 py-2 rounded transition text-sm font-medium">
      ...
      <div className="flex flex-col items-center mb-8 w-full">
        ...
        <div className="text-neutral-400 text-base w-full max-w-3xl">
          <h2 className="text-xl font-semibold text-white mt-6 mb-2">The platform serves three primary user groups:</h2>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">Architecture</h2>
          <p className="mb-2">Edu-Empower follows a modern client-server architecture with clear separation of concerns:</p>
          <div className="mb-4">
            <h3 className="text-lg font-semibold text-white mt-4 mb-1">Frontend</h3>
            ...
            <h3 className="text-lg font-semibold text-white mt-4 mb-1">Backend</h3>
            <ul className="list-disc list-inside ml-4">
          ...
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">For Students</h3>
          ...
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">For Organizations</h3>
          <ul className="list-disc list-inside ml-4 mb-2">
          ...
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">For Donors</h3>
          <ul className="list-disc list-inside ml-4 mb-2">
          ...
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Platform-Wide</h3>
          <ul className="list-disc list-inside ml-4 mb-2">
          ...
          <div className="w-full md:w-2/3 mb-8">
            ...
            <div className="mb-4">
              ...
              <h3 className="text-lg font-semibold text-white mt-4 mb-1">DevOps</h3>
              <div className="flex flex-wrap gap-2 mb-2">
              ...
              <h3 className="text-lg font-semibold text-white mt-4 mb-1">Development Tools</h3>
              <div className="flex flex-wrap gap-2 mb-2">
          ...
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Prerequisites</h3>
          <ul className="list-disc list-inside ml-4 mb-2">
          ...
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Clone the Repository</h3>
...
cd Edu-Empower
          ...
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Frontend Setup</h3>
          <pre className="bg-neutral-800 text-neutral-200 rounded p-4 text-xs overflow-x-auto mb-4">
cd Frontend
npm install
cp .env.example .env
# Edit .env with your configuration
          ...
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Backend Setup</h3>
          <pre className="bg-neutral-800 text-neutral-200 rounded p-4 text-xs overflow-x-auto mb-4">
cd Backend
npm install
cp .env.example .env
# Edit .env with your configuration
          ...
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Docker Setup (Optional)</h3>
          <pre className="bg-neutral-800 text-neutral-200 rounded p-4 text-xs overflow-x-auto mb-4">
docker-compose up -d
          </pre>

          <h2 className="text-2xl font-bold text-white mt-8 mb-4">Development Workflow</h2>
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Running the Frontend</h3>
          <pre className="bg-neutral-800 text-neutral-200 rounded p-4 text-xs overflow-x-auto mb-4">
cd Frontend
npm run dev
# The frontend will be available at http://localhost:5173.
          </pre>
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Running the Backend</h3>
          <pre className="bg-neutral-800 text-neutral-200 rounded p-4 text-xs overflow-x-auto mb-4">
cd Backend
npm run dev
# The backend API will be available at http://localhost:5000.
          </pre>
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Full Stack Development</h3>
          <pre className="bg-neutral-800 text-neutral-200 rounded p-4 text-xs overflow-x-auto mb-4">
# From the project root
npm run dev
          </pre>

          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Code Quality</h3>
          <pre className="bg-neutral-800 text-neutral-200 rounded p-4 text-xs overflow-x-auto mb-4">
# Frontend linting
cd Frontend
npm run lint
...
npm run format
          ...
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Testing</h3>
          <pre className="bg-neutral-800 text-neutral-200 rounded p-4 text-xs overflow-x-auto mb-4">
# Frontend tests
cd Frontend
npm test
...
npm run test:e2e
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">API Documentation</h2>
          <p className="mb-2">The Edu-Empower API follows RESTful principles and is organized around resources:</p>
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Authentication Endpoints</h3>
          <ul className="list-disc list-inside ml-4 mb-2">
          ...
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Student Endpoints</h3>
          <ul className="list-disc list-inside ml-4 mb-2">
          ...
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Scholarship Endpoints</h3>
          <ul className="list-disc list-inside ml-4 mb-2">
          ...
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Organization Endpoints</h3>
          <ul className="list-disc list-inside ml-4 mb-2">
          ...
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Donation Endpoints</h3>
          <ul className="list-disc list-inside ml-4 mb-2">
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">Deployment</h2>
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Frontend Deployment</h3>
...
# Deploy the dist directory to your hosting service.
          ...
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Backend Deployment</h3>
          <p className="mb-2">The backend can be deployed to various cloud platforms:</p>
          <h4 className="font-semibold text-white mt-2 mb-1">Heroku Deployment</h4>
          <pre className="bg-neutral-800 text-neutral-200 rounded p-4 text-xs overflow-x-auto mb-4">
cd Backend
heroku create edu-empower-api
git push heroku main
          </pre>
          <h4 className="font-semibold text-white mt-2 mb-1">Docker Deployment</h4>
          <pre className="bg-neutral-800 text-neutral-200 rounded p-4 text-xs overflow-x-auto mb-4">
docker build -t edu-empower-api ./Backend
docker push edu-empower-api
          </pre>
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Database Deployment</h3>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">Performance Optimization</h2>
          <ul className="list-disc list-inside ml-4 mb-2">
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">Contributing</h2>
          ...
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Contribution Guidelines</h3>
          <ul className="list-disc list-inside ml-4 mb-2">
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">Roadmap</h2>
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Short-term Goals (Next 3 Months)</h3>
          <ul className="list-disc list-inside ml-4 mb-2">
          ...
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Medium-term Goals (3-6 Months)</h3>
          <ul className="list-disc list-inside ml-4 mb-2">
          ...
          <h3 className="text-lg font-semibold text-white mt-4 mb-1">Long-term Goals (6+ Months)</h3>
          <ul className="list-disc list-inside ml-4 mb-2">
